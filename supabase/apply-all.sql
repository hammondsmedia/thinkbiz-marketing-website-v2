-- ThinkBiz marketing site — one-shot apply script
-- Generated from:
--   supabase/migrations/20260422140651_marketing_fields.sql
--   supabase/seed/marketing.sql
--   supabase/migrations/20260422140652_marketing_rls.sql
--
...
-- ══════════════════════════════════════════════════════════════════════════════
-- STEP 1 OF 3: SCHEMA (marketing fields + industries + club_seats)
-- ══════════════════════════════════════════════════════════════════════════════
...
-- ══════════════════════════════════════════════════════════════════════════════
-- STEP 2 OF 3: SEED DATA (95 industries, 3 chapters, 13 members, 32 seats)
-- ══════════════════════════════════════════════════════════════════════════════
...
-- ─── INDUSTRIES ───────────────────────────────────────────────────────────────
-- Canonical dropdown list. 94 regular categories sorted alphabetically (1–94)
-- plus "Other" (sort_order 999) which always appears last. club_seats.industry_slug
-- FKs to this table, so all 95 rows must exist before the club_seats inserts
-- further down run.
INSERT INTO public.industries (slug, name, sort_order) VALUES
  ('appliances', 'Appliances', 1),
  ('auto-car-body-shop', 'Auto/Car Body Shop', 2),
  ('auto-car-detailing', 'Auto/Car Detailing', 3),
  ('auto-car-repair', 'Auto/Car Repair', 4),
  ('auto-car-sales', 'Auto/Car Sales', 5),
  ('baker', 'Baker', 6),
  ('banking-services', 'Banking Services', 7),
  ('bookkeeping', 'Bookkeeping', 8),
  ('builder-general-contractor', 'Builder/General Contractor', 9),
  ('business-broker', 'Business Broker', 10),
  ('business-financing', 'Business Financing', 11),
  ('business-law', 'Business Law', 12),
  ('business-training-coach', 'Business Training/Coach', 13),
  ('carpet-upholstery-cleaning', 'Carpet, Upholstery Cleaning', 14),
  ('caterer', 'Caterer', 15),
  ('chiropractor', 'Chiropractor', 16),
  ('cleaning-service', 'Cleaning Service', 17),
  ('clothing-accessories', 'Clothing & Accessories', 18),
  ('cloud-infrastructure', 'Cloud Infrastructure', 19),
  ('commercial-insurance', 'Commercial Insurance', 20),
  ('commercial-real-estate', 'Commercial Real Estate', 21),
  ('commercial-sign-company', 'Commercial Sign Company', 22),
  ('copywriter-writer', 'Copywriter/Writer', 23),
  ('cosmetics-skin-care', 'Cosmetics/Skin Care', 24),
  ('counselor-psychologist', 'Counselor/Psychologist', 25),
  ('crm-rep', 'CRM Rep', 26),
  ('digital-marketing', 'Digital Marketing', 27),
  ('dry-cleaning-laundry', 'Dry Cleaning/Laundry', 28),
  ('electrician', 'Electrician', 29),
  ('estate-planning-law', 'Estate Planning Law', 30),
  ('event-venue-room-rental', 'Event Venue/Room Rental', 31),
  ('exterior-cleaning-power-washing', 'Exterior Cleaning/Power Washing', 32),
  ('family-law', 'Family Law', 33),
  ('financial-advisor-life-insurance', 'Financial Advisor/Life Insurance', 34),
  ('flooring', 'Flooring', 35),
  ('florist', 'Florist', 36),
  ('funeral-planning-services', 'Funeral Planning/Services', 37),
  ('general-dentist', 'General Dentist', 38),
  ('graphic-designer', 'Graphic Designer', 39),
  ('grout-tile-installer', 'Grout & Tile Installer', 40),
  ('handyman', 'Handyman', 41),
  ('health-facility-gym-club', 'Health Facility/Gym Club', 42),
  ('health-insurance', 'Health Insurance', 43),
  ('home-auto-insurance', 'Home & Auto Insurance', 44),
  ('home-staging', 'Home Staging', 45),
  ('hotel', 'Hotel', 46),
  ('human-resources', 'Human Resources', 47),
  ('hvac-heating-air', 'HVAC – Heating & Air', 48),
  ('inspector', 'Inspector', 49),
  ('interior-decorator', 'Interior Decorator', 50),
  ('it-networks', 'IT & Networks', 51),
  ('journeyman-carpenter', 'Journeyman/Carpenter', 52),
  ('landscape-services', 'Landscape Services', 53),
  ('life-coach', 'Life Coach', 54),
  ('lighting-retailers', 'Lighting Retailers', 55),
  ('locksmith', 'Locksmith', 56),
  ('massage-therapist', 'Massage Therapist', 57),
  ('merchant-services', 'Merchant Services', 58),
  ('metal-work', 'Metal Work', 59),
  ('mobile-telecom', 'Mobile Telecom', 60),
  ('moving-company', 'Moving Company', 61),
  ('musician', 'Musician', 62),
  ('nonprofit', 'Nonprofit', 63),
  ('nutritional-supplements', 'Nutritional Supplements', 64),
  ('office-equipment-machines', 'Office Equipment/Machines', 65),
  ('painter', 'Painter', 66),
  ('payroll-service', 'Payroll Service', 67),
  ('personal-injury-law', 'Personal Injury Law', 68),
  ('personal-trainer-fitness', 'Personal Trainer – Fitness', 69),
  ('pest-control', 'Pest Control', 70),
  ('photographer', 'Photographer', 71),
  ('physical-therapist', 'Physical Therapist', 72),
  ('plumbing', 'Plumbing', 73),
  ('printer-promotionals', 'Printer/Promotionals', 74),
  ('property-management', 'Property Management', 75),
  ('renovations-remodeling', 'Renovations/Remodeling', 76),
  ('residential-mortgages', 'Residential Mortgages', 77),
  ('residential-real-estate', 'Residential Real Estate', 78),
  ('restoration', 'Restoration', 79),
  ('restaurant', 'Restaurant', 80),
  ('roofing-gutters', 'Roofing & Gutters', 81),
  ('salon-spa', 'Salon/Spa', 82),
  ('security-systems', 'Security Systems', 83),
  ('software-developer', 'Software Developer', 84),
  ('solar', 'Solar', 85),
  ('tax-advisor-tax-cpa', 'Tax Advisor/Tax CPA', 86),
  ('tire-sales-replacement', 'Tire Sales/Replacement', 87),
  ('title-services', 'Title Services', 88),
  ('travel-agent', 'Travel Agent', 89),
  ('videographer-film-producer', 'Videographer/Film Producer', 90),
  ('virtual-assistant-va', 'Virtual Assistant (VA)', 91),
  ('web-design-development', 'Web Design & Development', 92),
  ('window-treatments', 'Window Treatments', 93),
  ('windows-doors', 'Windows & Doors', 94),
  ('other', 'Other', 999)
...
-- ══════════════════════════════════════════════════════════════════════════════
-- STEP 3 OF 3: ROW-LEVEL SECURITY (anon read policies for public rows)
-- ══════════════════════════════════════════════════════════════════════════════
